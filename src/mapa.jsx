    ...
    return (
        <section className="mapa">
            ...
            <section className="painel">
                ...
                {pontos.length === 0 ? (
                    <p className="adicionar-ponto">
                        Nenhum ponto adicionado. Clique no mapa para adicionar
                    </p>
                ) : (
            ...
            <MapContainer center={posicao ? local : centroInicial} zoom={zoomInicial} scrollWheelZoom={true}  className="mapaMap">
